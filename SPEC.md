...
**用途**：作为 Agent Team 系统的实验对象，测试任务分配与协作流程。
...
| 路径 | `~/.openclaw/workspace/skills/superpowers/` |
| 功能 | 工程级开发流程（头脑风暴→计划→开发→调试→完成） |

**Pipeline**: `Idea → Brainstorm → Plan → Subagent-Driven Build (TDD) → Code Review → Finish Branch`
